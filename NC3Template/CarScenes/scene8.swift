...
//        self.view.insertSubview(backgroundImage, at: 0)
    ...
    @IBAction func C1(_ sender: Any) {
        buttonSound.play()
        performSegue(withIdentifier: "8C1", sender: nil)
        bgSound.stop()
    }
    @IBAction func C2(_ sender: Any) {
        buttonSound.play()
        performSegue(withIdentifier: "8C2", sender: nil)
        bgSound.stop()
    }
    @IBAction func C3(_ sender: Any) {
        buttonSound.play()
        performSegue(withIdentifier: "8C3", sender: nil)
        bgSound.stop()
    }
